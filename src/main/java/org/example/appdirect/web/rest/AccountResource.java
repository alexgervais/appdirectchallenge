...
public class AccountResource {
    ...
    public ResponseEntity<Account> getAccount() {
        ...
        final UserDetails currentUserDetails = userDetailsService.getCurrentUserDetails();
        if (currentUserDetails == null) {
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }

        return new ResponseEntity<>(accountMapper.map(currentUserDetails), HttpStatus.OK);
    }
